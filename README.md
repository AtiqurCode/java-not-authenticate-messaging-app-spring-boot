...
[**▶️ Watch Demo Video**](public/screenshots/demo.webm)

> Click the link above to watch the application demo. Alternatively, convert the `.webm` file to `.gif` for inline display in GitHub.
